...
agent_blob, agent_name = build_agentstudio_presentation(agent_payload, "5.369")
...
workflow_blob, workflow_name = build_agentstudio_presentation(workflow_payload, "5.369")
...
studio_blob, studio_name = build_agentstudio_presentation(studio_payload, "5.369")
...
print("PASS v5.369 Separated Agent / Studio PPT Export contract")
