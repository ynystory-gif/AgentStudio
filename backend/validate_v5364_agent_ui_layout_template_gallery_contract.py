...
checks={
 ...
 'backend version':'version="5.371"' in MAIN and '"version": "5.371"' in ROUTES,
}
failed=[k for k,v in checks.items() if not v]
if failed: raise SystemExit('v5.371 contract failed: '+', '.join(failed))
print('PASS v5.371 Agent UI Layout Template Gallery contract')
