...
def fail(message: str) -> None:
    raise SystemExit(f"FAIL v5.503: {message}")
...
require("AGENTSTUDIO_FRONTEND_VERSION='5.503'" in source, "frontend version is not 5.503")
...
print("PASS v5.503 TypeScript strict stabilization + core regression contract")
