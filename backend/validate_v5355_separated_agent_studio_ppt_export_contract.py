...
agent_blob, agent_name = build_agentstudio_presentation(agent_payload, "5.371")
...
workflow_blob, workflow_name = build_agentstudio_presentation(workflow_payload, "5.371")
...
studio_blob, studio_name = build_agentstudio_presentation(studio_payload, "5.371")
...
print("PASS v5.371 Separated Agent / Studio PPT Export contract")
