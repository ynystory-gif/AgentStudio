...
checks = {
    'frontend version 5.338': "AGENTSTUDIO_FRONTEND_VERSION='5.356'" in APP,
    ...
    'summary card shown to user': '첨부 파일에서 파악한 만들고자 하는 내용' in APP and 'attachment-intent-summary' in STYLE,
