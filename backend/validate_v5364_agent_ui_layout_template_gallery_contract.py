...
checks={
 ...
 'backend version':'version="5.368"' in MAIN and '"version": "5.368"' in ROUTES,
}
failed=[k for k,v in checks.items() if not v]
if failed: raise SystemExit('v5.368 contract failed: '+', '.join(failed))
print('PASS v5.368 Agent UI Layout Template Gallery contract')
