...
def require(ok,msg):
    if not ok:
        raise SystemExit('FAIL v5.371: '+msg)
...
require('$FallbackAgentStudioVersion = "5.371"' in PS1,'launcher version')
...
print('PASS v5.371 Failed Build Resume Checkpoint contract')
