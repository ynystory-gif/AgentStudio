...
export function LlmLearningCenter() {
  ...
  const downloadRecommended=()=>run('qwen3.5:4b 다운로드·적용',()=>api('/learning/recommended-ollama/download-apply',{method:'POST'}))
  ...
  const page=open?createPortal(
    <section className="llm-learning-page" aria-label="LLM 학습 센터">
