...
require('version="5.371"' in MAIN or "version='5.371'" in MAIN, "backend version must be 5.371")
require('"version": "5.371"' in ROUTES, "health version must be 5.371")
...
content, _ = build_agentstudio_presentation(payload, "5.371")
...
print("PASS v5.371 Large Architecture Visual Asset contract")
