...
checks={
 ...
 'backend version': 'version="5.368"' in MAIN,
...
if failed: raise SystemExit('FAIL v5.368: '+', '.join(failed))
print('PASS v5.368 Frontend Input / Memory / Layout Visibility contract')
