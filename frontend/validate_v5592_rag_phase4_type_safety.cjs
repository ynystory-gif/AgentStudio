...
for(const safe of [
  ...
  if(!ragSource.includes(safe)){console.error('[FAIL] missing strict-safe narrowing: '+safe);process.exit(1);}
}
console.log('[PASS] RagStudio strict-safe first-item narrowing');
